                    ...
                    <div class="m-l-25 m-r--38 m-lr-0-xl">
                        <div class="wrap-table-shopping-cart" style="">
                            <table class="table-shopping-cart">
                                <tr class="table_head">
                                    ...
                                    <th class="column-6"style="text-align: center; padding-right: 20px ">Action</th>
                                </tr>
                                ...
                                @foreach ($cart->items as $item)
                                    <tr class="table_row" >
                                        ...
                                        <form action="{{ route('updateCart', ['id' => $item['id']]) }}" method="get">
                                            ...
                                            <td class="column-5"style="padding-right:30px">{{ number_format( $cart->get_price_of_item($item['id']) ) . ' VNĐ' }}</td>
                                            <td class="column-6"style="padding-right:30px; align-item:center">
                                                <input type="submit" class="flex-c-m stext-101 cl2 size-11 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" value="Update">
                                            </td>
                                        </form>
                                    </tr>
                                @endforeach
                        ...
                        <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm fff">
							...
							<div class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10 ">
								<a href="{{route('clearCart')}}">Clear All</a>
							</div>
						</div>
                    </div>
                </div>
