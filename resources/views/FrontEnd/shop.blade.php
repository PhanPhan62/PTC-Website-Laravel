        ...
        <div class="container">
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    @foreach ($category as $i)
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{ $i->id }}">
                            {{ $i->TenLoaiSP }}
                        </button>
                    @endforeach
                    ...
                    <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                        ...
                        <div class="filter-col3 p-r-15 p-b-27">
                            ...
                            <ul>
                                @foreach ($col as $item)
                                    <li class="p-b-6">
                                        <span class="fs-15 lh-12 m-r-6" style="color: {{$item->TenMau}};" title="{{$item->MoTa}}">
            ...
            <div class="row isotope-grid">
                @foreach ($product2 as $item)
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{ $item->MaLoaiSP }}">
                        <!-- Block2 -->
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('/uploads') }}/{{ $item->AnhDaiDien }}" alt=" {{ $item->TenSanPham }}">

                                <a href="{{ route('addCart', ['id' => $item->id]) }}"
