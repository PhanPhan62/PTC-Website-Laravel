                                ...
                                <div class="block2">
                                    ...
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        <div class="block2-txt-child1 flex-col-l ">
                                            <a href="{{route('productdetail',['id'=>$sp->id])}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                                {{$sp->TenSanPham}}
                                            </a>

                                            <span class="stext-105 cl3">
                                                {{number_format($sp->GiaBan)}} VNĐ
                                            </span>
                                        </div>
                            ...
                            <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        ...
                                        <a href="{{route('addCart',['id'=>$item1->id])}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
                                            Add to Cart
                                        </a>
                                    </div>
