        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    ...
                    <li class="p-b-10">
                        <a href="{{route('shop',['id'=>$item->id])}}" class="stext-107 cl7 hov-cl1 trans-04">
                            {{$item->TenLoaiSP}}
                        </a>
                    </li>
                    @endforeach
{{-- 
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                </script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Công</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
