                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                @foreach ($chitietanh as $item1)
                                    <div class="item-slick3 "
                                        data-thumb="/uploads/ChiTiet/{{ $item1->Anh }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="/uploads/{{ $item1->AnhDaiDien }}"
                                                alt="{{ $item1->TenSanPham }}">
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="/uploads/{{ $item1->AnhDaiDien }}">
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2" name="time">
                                            ...
                                            @foreach ($mau as $item)
                                                <option value="{{ $item->id }}" style="text-transform:capitalize;">
                                                    {{-- <div style="width: 20px;height: 20px;border: 1px solid #d0d0d0; background-color: {{$item->TenMau}}"></div> --}}
                                                    {{ $item->MoTa }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="/uploads/{{ $item->AnhDaiDien }}" alt="IMG-PRODUCT">
