        ...
        <nav class="sidebar-nav">
            <ul>
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul id="ddmenu_1" class="show collapse dropdown-nav">
                        <li>
                            <a href="/admin" class=""> eCommerce </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul id="ddmenu_2" class="collapse dropdown-nav">
                        <li>
                            <a href="/category"> Loại sản phẩm </a>
                        </li>
                        <li>
                            <a href="/product"> Sản phẩm </a>
                        </li>
                        <li>
                            <a href="/dvt"> Đơn vị tính </a>
                        </li>
                        <li>
                            <a href="/mau"> Màu sắc </a>
                        </li>
                        <li>
                            <a href="/size"> Size </a>
                        </li>
                        <li>
                            <a href="/nhasanxuat"> Nhà sản xuất </a>
                        </li>
                    </ul>
                </li>
                {{-- <li class="nav-item">
