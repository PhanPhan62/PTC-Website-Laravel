        ...
        <div class="tables-wrapper ">  
            <div class="col-mr-3"> 
                <nav aria-label="breadcrumb">
                    ...
                    <a href="{{ url('/mau/create') }}" class="main-btn active-btn-outline rounded-md btn-hover" style="padding: 10px 25px; margin-bottom: 5px;">Add</a>
                    </div>
                </div>
            <!-- end col -->
                                    ...
                                    @foreach ($mau as $item)
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <div class="lead">
                                                    <div class="lead-text" >
                                                        <p style="height: 20px; width: 20px;border-radius: 50px;border: 1px solid rgb(0, 255, 51); background:{{$item->TenMau}} "></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="min-width">
                                            ...
                                            <td>
                                                <div class="action" >
                                                    <a style="cursor: pointer" href="{{ url('/mau/show/' . $item->id) }}" class="text-dark mr-10">
                                                        <i class="lni lni-eye" title="View"></i>
                                                    </a>
                                                    <a style="cursor: pointer" href="{{route('edit.mau', $item->id)}}" class="text-info  mr-10">
                                                        <i class="lni lni-write" title="Edit"></i>
                                                    </a>
                                                    <form method="POST" action="{{ route('destroy.mau', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
