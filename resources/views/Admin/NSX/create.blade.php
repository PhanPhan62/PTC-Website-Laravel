...
@section('content_admin')
    ...
    <section class="tab-components">
        ...
        <div class="form-elements-wrapper">
            <div class="row">
                <form action="{{ route('store.nhasanxuat') }}" class="col-lg-6 mx-auto" method="POST">
                    {!! csrf_field() !!}
                    <!-- input style start -->
                    <div class="card-style mb-30" >
                        ...
                        <div class="input-style-1">
                            <label>Tên NSX</label>
                            <input type="text" placeholder="Tên NSX"  name="TenNSX" required id="name"/>
                        </div>
                        <div class="input-style-1">
                            <label>Số Điện Thoại</label>
                            <input type="text" placeholder="Số Điện Thoại"  name="SoDienThoai" required id="sdt"/>
                        </div>
                        <div class="input-style-1">
                            <label>Email</label>
