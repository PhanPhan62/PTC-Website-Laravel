    ...
    <section class="tab-components">
        ...
        <div class="container-fluid">
            ...
            <div class="form-elements-wrapper">
                <div class="row">
                    <form action="{{ route('store.product') }}" class="col-lg-6 mx-auto" method="POST"
                        ...
                        <div class="card-style mb-30">
                            ...
                            <div class="input-style-1">
                                ...
                                <input type="text" name="TenSanPham" required placeholder="Tên Sản Phẩm" value=""
                                    id="TenSanPham" />
                            </div>
                            <div class="input-style-1 ">
                                <label for="GiaBan">Giá</label>
                                <input type="number" name="GiaBan" required value="" placeholder="Giá"
                                    id="GiaBan" />
                            </div>
                            <div class="input-style-1 ">
                                <label for="MoTaSanPham">Mô Tả</label>
                                <input type="text" name="MoTaSanPham" required value="" placeholder="Mô tả"
                                    id="MoTaSanPham" />
                            </div>
                            ...
                            <div class="input-style-1 ">
                                ...
                                <input type="file" name="Anhs[]" accept="image/*" multiple required value=""
                                    multiple id="Anh" />
                            </div>
                            ...
                            <!-- end input -->
                            <input type="submit"
                                value="Save"class=" main-btn success-btn-outline rounded-full btn-hover ">
