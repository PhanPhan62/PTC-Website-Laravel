    ...
    <div class="card" style="margin:20px;">
        ...
        <div class="card-body">
            <div class="card-body">
                ...
                <p class="card-text"><span style="font-weight: bold">Ảnh sản phẩm :</span> <img
                        style="height: 200px; margin-left: 20px" src="{{ asset('' . 'uploads/' . $sanpham->AnhDaiDien) }}"
                        alt="{{ $sanpham->AnhDaiDien }}"></p>
                <p class="card-text"><span style="font-weight: bold">Mô Tả sản phẩm :</span> {{ $sanpham->MoTaSanPham }}</p>
                <p class="card-text"><span style="font-weight: bold">Giá bán sản phẩm :</span>
                    {{ number_format($sanpham->GiaBan) }} VNĐ</p>
                ...
                <p class="card-text">
                    <span style="font-weight: bold">Màu :
                        <p title="{{ $sanpham->MoTa }}"
                            style="width: 20px; height: 20px; border: 1px solid black; background:{{ $sanpham->TenMau }}; border-radius: 50%">
                        </p>
                    </span>
                </p>
